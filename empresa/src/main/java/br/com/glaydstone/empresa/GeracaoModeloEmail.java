package br.com.glaydstone.empresa;
...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[empresa]");
        ...
        salvarModeloEmail("[empresa] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[empresa] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
