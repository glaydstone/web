package br.com.glaydstone.empresa.maker;

import br.com.glaydstone.empresa.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.com.glaydstone.empresa.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.com.glaydstone.empresa.application.BaseDAOImpl";
    }
